...
public class UniqueLinkCountJob extends Configured implements Tool {
    ...
    private Job getJobConf(String input, String output) throws IOException {
        ...
        job.setJarByClass(UniqueLinkCountJob.class);
        job.setJobName(UniqueLinkCountJob.class.getCanonicalName());
    ...
    static public void main(String[] args) throws Exception {
        int ret = ToolRunner.run(new UniqueLinkCountJob(), args);
        System.exit(ret);
    }
}
