...
public class SortJobOut extends Configured implements Tool {
    public static class Sort1Mapper extends Mapper<Text, Text, DoubleWritable, Text> {
        ...
        protected void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new DoubleWritable(node.weightOut), key);
        }
    }
    ...
    private Job getJobConf(String input, String output) throws IOException {
        ...
        job.setJarByClass(SortJobOut.class);
        job.setJobName(SortJobOut.class.getCanonicalName());
    ...
    static public void main(String[] args) throws Exception {
        int ret = ToolRunner.run(new SortJobOut(), args);
        System.exit(ret);
    }
}
